    ...
    <div class="row">
        <div class="col-md-4 mx-auto">
            ...
            <form action="actions/register_action.php" method="post">
                ...
                <input class="form-control mb-2" type="text" id="r_user" name="user" placeholder="Username">
                <i class="fa fa-envelope"></i> <label for="r_email">Email:</label>
                <input class="form-control mb-2" type="text" id="r_email" name="email" placeholder="Email">
                <i class="fa fa-key"></i> <label for="r_pass">Password:</label>
                <input class="form-control" type="password" id="r_pass" name="pass">
